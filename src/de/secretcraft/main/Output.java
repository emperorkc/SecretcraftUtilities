...
public class Output {
	...
	public static void Err(Player p, String nr) {
		...
		case "cUse1":
			...
			break;
		case "cUse2":
			p.sendMessage(prefix + " §cKorrekte Nutzung: /flag kaufen <regionsname> <flagname> <ein/aus/text>");
			break;
		case "cUse3":
		...
		case "cUse10":
			p.sendMessage(prefix
					+ " §cKorrekte Nutzung: /flag <help/kaufen/add/remove/preis/info/del/forbid/allow/forbiddenflags>");
			break;
		case "cUse11":
		...
		case "aExist":
			p.sendMessage(prefix
					+ " §cDiese Region existiert bereits. Lösche sie mit /gs del <name>, sollte sie deine Region sein.");
			break;
		case "nPerm":
			p.sendMessage(prefix + " §cDu hast hierzu keine Rechte.");
			break;
		...
		case "nOwner":
			...
			break;
		case "nName":
			p.sendMessage(prefix + " §cLege zuerst einen Namen für deine Region fest -->/gs <name>.");
			break;
		case "aExp":
		...
		case "eRedo":
			...
			break;
		case "cUse18":
			p.sendMessage(prefix + " §cKorrekte Nutzung: /gs <name>/info/vert/up/down/redo/del. Mehr dazu: /gs info");
			break;
		case "cUse19":
	...
	public static void suc(Player p, String nr) {
		...
		case "info1":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lPVP§2 erlaubt es dir PVP auf deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§laus");
			break;
		case "info2":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lGREETING§2 erlaubt es dir eine Begrüßung im Chat erscheinen zu lassen, wenn ein Spieler deine Region betritt.");
			break;
		case "info3":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lFAREWELL§2 erlaubt es dir einen Abschiedsgruß im Chat erscheinen zu lassen, wenn ein Spieler deine Region verlässt.");
			break;
		case "info4":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lSNOW-FALL§2 erlaubt es dir den Scheefall in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§lein");
			break;
		case "info5":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lCREEPER-EXPLOSION§2 erlaubt es dir Explosionen von Creepern in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§laus");
			break;
		case "info6":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lOTHER-EXPLOSION§2 erlaubt es dir Explosionen in deiner Region einzuschalten oder auszuschalten.In Städten standardmäßig §4§laus");
			break;
		case "info7":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lTNT§2 erlaubt es dir TNT in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§lein");
			break;
		case "info8":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lLIGHTER§2 erlaubt es dir die Nutzung von Feuerzeugen in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§lein");
			break;
		case "info9":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lICE-MELT§2 erlaubt es dir das schmelzen von Eis in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§lein");
			break;
		case "info10":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lICE-FORM§2 erlaubt es dir das Formen von Eis in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§lein");
			break;
		case "info11":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lSNOW-MELT§2 erlaubt es dir das schmelzen von Schnee in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§laus");
			break;
		case "info12":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lBUILD§2 erlaubt es dir für alle anderen Spieler die Fähigkeit des Bauens in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§laus");
			break;
		case "info13":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lMOB-SPAWNING§2 erlaubt es dir das Spawnen von Mobs in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§laus");
			break;
		case "info14":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lENDERPEARL§2 erlaubt es dir das Nutzen von Enderperlen in deiner Region einzuschalten oder auszuschalten. In Städten standardmäßig §4§lein");
			break;
		case "info15":
			p.sendMessage(prefix
					+ " §2Die Flag §4§lHOSTILEMOBSPAWN§2 erlaubt es dir das Spawnen von Monstern einzuschalten oder auszuschalten. In Städten standardmäßig §4§laus");
			break;
		...
		case "supPl":
			p.sendMessage(prefix
					+ " §bDie folgenden Flags werden vom Plugin unterstützt: §2snow-fall, pvp, build, mob-spawning, creeper-explosion, enderpearl, other-explosion, tnt, lighter, snow-melt, ice-form, ice-melt, greeting, farewell, hostilemobspawn");
			break;
		case "sDeny":
		...
		case "aAllow":
			...
			break;
		case "helpAdmin":
			p.sendMessage(prefix + " §2/flag kaufen <region> <flag> <ein/aus/text> §3- Kaufe eine bestimmte Flag");
			...
			p.sendMessage(prefix + " §2/flag forbid <region> <flag> §3- Verbiete eine Flag für eine Region");
			p.sendMessage(prefix + " §2/flag allow <region> <flag> §3- Erlaube eine Flag für eine Region");
			p.sendMessage(prefix + " §2/flag forbiddenflags <flag> §3- Sehe verbotene Regionen der Flag ein");
		...
		case "forbFlags":
			p.sendMessage(prefix
					+ " §2Um die verboteten Flags einzusehen, schaue bitte in der Config nach. Aufrufen per Command ist nicht möglich. ");
			break;
		...
		case "sVert":
			p.sendMessage(prefix
					+ " §2Du hast die Region erfolgreich §3Vertikal§2 erweitert. Nun bestätige deine Auswahl mit /gs confirm");
			break;
		case "info":
			p.sendMessage(prefix
					+ " §2Solltest du mitten in deiner Regionskonfiguration einen Fehler machen, benutze /gs redo. Dann fange wieder beim Namen an.");
			...
			break;
		case "sRedo":
			p.sendMessage(prefix + " §2Mit dem Einrichten des Grundstücks kann nun erneut begonnen werden.");
			break;
		case "nowNext1":
			p.sendMessage(prefix
					+ " §2Name der Region erfolgreich gesetzt. Expandiere nun deine Region (§4/gs info§2) oder bestätige deine Wahl mit §4/gs confirm ");
