...
public class votedToday {
	...
	public static void addVote(Player p) throws IOException {
		...
		if(Config.getString("Spieler."+p.getUniqueId())==null) {
			...
			if(VotedPlayers.getRewardAttach(votedToday.getStreak(p))!=null && !votedToday.isPickedUp(p, votedToday.getStreak(p))) {
				
				Bukkit.broadcastMessage("§3§o"+p.getName()+"§e hat §3§l"+votedToday.getStreak(p)+ " §eTage hintereinander gevotet!");
			}
		} else {
		if(Config.getInt("Spieler."+p.getUniqueId()+".Monat")!=Month ||Config.getInt("Spieler."+p.getUniqueId()+".Tag")!=day ) {
		if(day!=1) {
		if(Config.getInt("Spieler."+p.getUniqueId()+".Monat")==Month &&Config.getInt("Spieler."+p.getUniqueId()+".Tag")==day-1) {
			
		
		Config.set("Spieler."+p.getUniqueId()+".Monat", Month);
		Config.set("Spieler."+p.getUniqueId()+".Tag", day);
		
		Config.set("Spieler."+p.getUniqueId()+".Streak", Config.getInt("Spieler."+p.getUniqueId()+".Streak")+1);
		
		} else if(Config.getInt("Spieler."+p.getUniqueId()+".Tag")<=day-2  ||Config.getInt("Spieler."+p.getUniqueId()+".Tag")>=day) {
			
			Config.set("Spieler."+p.getUniqueId()+".Monat", Month);
			Config.set("Spieler."+p.getUniqueId()+".Tag", day);
			if(Config.getInt("Spieler."+p.getUniqueId()+".Streak")>6) {
			Config.set("Spieler."+p.getUniqueId()+".Streak", Config.getInt("Spieler."+p.getUniqueId()+".Streak")-6);
			} else {
				Config.set("Spieler."+p.getUniqueId()+".Streak", 1);
			}
			...
			if(Month== 2 ||Month== 4 ||Month== 6 ||Month== 9 ||Month== 11 ) {
				if(Config.getInt("Spieler."+p.getUniqueId()+".Monat")==Month-1 &&Config.getInt("Spieler."+p.getUniqueId()+".Tag")==31) {
				...
				if(Config.getInt("Spieler."+p.getUniqueId()+".Monat")==Month-1 &&(Config.getInt("Spieler."+p.getUniqueId()+".Tag")==28||Config.getInt("Spieler."+p.getUniqueId()+".Tag")==29)) {
				...
				if(Config.getInt("Spieler."+p.getUniqueId()+".Monat")==Month-1 &&Config.getInt("Spieler."+p.getUniqueId()+".Tag")==30) {
				...
				if(Config.getInt("Spieler."+p.getUniqueId()+".Monat")==12 &&Config.getInt("Spieler."+p.getUniqueId()+".Tag")==31) {
