...
public boolean onCommand(CommandSender arg0, Command arg1, String arg2, String[] arg3) {
	...
	sm2.setLore(Arrays.asList("§7TheFlooh","§7marc3108"));
	...
	sm3.setLore(Arrays.asList("§7Atterbhog"));
	...
	sm4.setLore(Arrays.asList("§7Baeumchen", "§7ValyrX"));
	...
	sm5.setLore(Arrays.asList("§cEmperor-KC","§7Krizso95","§7FantasyFlash","§7David14821","§7Loiytzia1","§7einszweidreidein","§7Aetios87, §7Legowaaas"));
	...
	sm6.setLore(Arrays.asList("§7Sunnij","§7iRedic"));
	...
	menu.addButton(menu.getRow(1), 2, skull3);
	menu.addButton(menu.getRow(1), 3, skull4);
	menu.addButton(menu.getRow(1), 4, skull5);
	menu.addButton(menu.getRow(1), 5, skull6);
