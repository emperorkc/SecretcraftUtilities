						...
						if (arg3.length > 3) {
							if (arg3[0].charAt(2) == '.' && arg3[0].charAt(5) == '.' && arg3[1].charAt(2) == ':') {
								...
								if (date1 != null) {
									...
									p.sendMessage(prefix+" §6Folgende Nachricht wird Spielern beim betreten des Servers angezeigt:");
									p.sendMessage("");
									p.sendMessage(prefix+" §b"+bezeichung+" §2am §3"+EventJoinListener.getDate(bezeichung)+" §2um §3"+EventJoinListener.getHour(bezeichung)+":"+b+" §2Uhr:");
